            ...
            <div className="grid  max-w-md grid-cols-1 mx-auto mt-12 lg:max-w-full lg:mt-16 lg:grid-cols-3 gap-x-16 gap-y-12">
              <div>
                ...
                <span className="block text-sm font-bold tracking-widest text-gray-500 uppercase">
                  {" "}
                  Oliver Omnibus. Feb 12, 2025{" "}
                </span>
                <h4 className="block text-sm font-bold tracking-widest text-black-500 uppercase">Held on 18 March 2025, near Addayar Chennai</h4>
              </div>
              ...
              <div>
                ...
                <span className="block text-sm font-bold tracking-widest text-gray-500 uppercase">
                  {" "}
                  Sofia Storyteller . January 12, 2025{" "}
                </span>
                <h4 className="block text-sm font-bold tracking-widest text-black-500 uppercase">Held on 18 March 2025, near Borivalli-East</h4>
              </div>
            </div>
          </div>
        </section>
